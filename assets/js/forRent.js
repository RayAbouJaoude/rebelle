$(document).ready(function (){
    ...
    $("#openMapViewButton").click(function(){
        ...
        $("#propertyForRentContainer").addClass("displayNone");
        getAllPropertiesForRentInMapView();
        displayAllPins();
    })
})

// ----------------------------------------------------------- //
function getAllPropertiesForRent() {
    $.ajax({
        url: baseURL + "/ForRent/getAllPropertiesForRent",
        method: "POST",
        dataType: "json",
        beforeSend:function(){
            $(".loader").fadeIn(200);
        ...
        success: function (data) {
            $("#propertyForRentContainer").html(data); 
...
function displayAllPins(){
    $.ajax({
        url: baseURL + "/ForRent/displayAllPins",
        method: "POST",
        dataType: "json",
        beforeSend:function(){
            $(".loader").fadeIn(500);
                    ...
                    map.loadImage(
                        ...
                        (error, image) => {
                            ...
                            map.on('click', 'points', (e) => {
                                ...
                                $("#propertyForRentInMapViewContainer").animate({
                                    scrollTop:$(".propertyOnHover[propertyid='" + e.features[0].properties.message + "']").offset().top 
                                }, 500);
                                
                                var container = $('#propertyForRentInMapViewContainer').children();
...
// ----------------------------------------------------------- //
function getAllPropertiesForRentInMapView() {
    $.ajax({
        url: baseURL + "/ForRent/getAllPropertiesForRentInMapView",
        method: "POST",
        dataType: "json",
        beforeSend:function(){
            $(".loader").fadeIn(200);
        ...
        success: function (data) {
            $("#propertyForRentInMapViewContainer").html(data); 
